...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 46.0, 28.0, 122.0, 116.0 ],
					"varname" : "bp.Constant",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 309.0, 98.0, 39.0 ],
					"style" : "",
					"text" : "set PWM to 100"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 446.0, 187.0, 101.0, 116.0 ],
					"varname" : "bp.Scope[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 97.0, 189.0, 24.0 ],
					"style" : "",
					"text" : "control pulse width modulation"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 309.0, 42.0, 137.0, 116.0 ],
					"varname" : "bp.LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 590.0, 516.0, 92.0, 24.0 ],
					"style" : "",
					"text" : "set to 1v/oct"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 181.0, 35.0, 101.0, 116.0 ],
					"varname" : "bp.Scope",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 309.0, 82.0, 39.0 ],
					"style" : "",
					"text" : "set to square"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 210.0, 394.0, 372.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 46.0, 485.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 191.0, 314.0, 116.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-11::obj-52" : [ "multiply", "multiply", 0 ],
			...
			"obj-11::obj-129" : [ "Points", "Points", 0 ],
